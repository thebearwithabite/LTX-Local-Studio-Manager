...
import { CURATOR_SCHEMA, SOURCE_LIST_SCHEMA } from "../src/services/gemini.js";
...
JSON ONLY. NO PROSE.`;
export async function runAutonomousScrape(query) {
    ...
    try {
        ...
        if (dataset.length === 0)
            return { success: false, error: "No data curated" };
        // 3. Save to data dir
